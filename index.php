...
<!-- Banners -->
<section id="banner" class="banner-section" style='background-image:url("front-image.jpg")';>
    <div class="div_zindex">
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find Your Perfect bike</h1>
            <p> I Eshheet and Gaurang will assure to make your ride best by providing best service. </p>
    ...
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">BIKES WE GOT FOR YOU</a></li>
        </ul>
      </div>
